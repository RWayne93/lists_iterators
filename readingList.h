...
public:
	...
	typedef int const_iterator; // replace this by an appropriate type for the const iterator
	typedef const_iterator iterator;


	/**
	 * Create a new empty reading list.
	 */
	ReadingList();
	 ...
	 *      end() if the ID is unknown.
	 * 
	 * @post find(id) == end() || find(id)->getID() == id
	 */
